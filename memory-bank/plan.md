...
| S8-22 | Leaderboard TimescaleDB continuous aggregate views: `quiz_leaderboard_weekly` and `quiz_leaderboard_monthly` (deferred from S6-05 — views were referenced in quiz.service.ts leaderboard endpoint but never created in a migration) | QuizModule | P1 |
